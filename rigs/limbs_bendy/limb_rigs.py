...
class BaseLimbBendyRig(BaseRig):
    ...
    def parent_tweak_bone(self, i, ctrl, entry):
        if i == 0:
            self.set_bone_parent(ctrl, self.rig_parent_bone, inherit_scale='FIX_SHEAR')
        else:
            self.set_bone_parent(ctrl, entry.org)
    ...
    def parent_deform_chain(self):
        ...
        self.parent_bone_chain(self.bones.make_deform_bone)
